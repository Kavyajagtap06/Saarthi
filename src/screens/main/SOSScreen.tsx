...
export default function SOSScreen() {
  ...
  const playEmergencySound = async () => {
    try {
      ...
      try {
        const { sound: newSound } = await Audio.Sound.createAsync(
          {
            uri: "https://assets.mixkit.co/active_storage/sfx/250/250-preview.mp3",
          }, // Emergency beep
          {
            shouldPlay: true,
            isLooping: true,
  ...
  const callEmergency = (number: string) => {
    ...
    Linking.openURL(`tel:${number}`).catch((err) =>
      Alert.alert(
        "Error",
        "Could not make the call. Please check if your device supports calling."
      )
    );
  };
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              "Recording Started",
              "Video recording with audio has started for evidence."
            );
            ...
            setTimeout(() => {
              if (isVideoRecording) {
                ...
                Alert.alert(
                  "Recording Stopped",
                  "Video recording automatically stopped after 2 minutes."
                );
              }
            }, 120000);
          },
  ...
  const stopVideoRecording = () => {
    ...
    Alert.alert(
      "Recording Stopped",
      "Video recording has been saved for evidence."
    );
  };
  ...
  const stopAudioRecording = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Recording Saved",
        "Audio recording has been saved for evidence."
      );
    } catch (err) {
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            Alert.alert(
              "Fake Call Scheduled",
              "You will receive a fake call in 10 seconds with loud ringtone."
            );
        ...
        <View style={styles.sosSection}>
          ...
          >
            ...
            <Text style={styles.sosButtonSubtext}>
              {isSOSActive
                ? "Tap to stop emergency sound"
                : "Tap for emergency - Plays loud sound"}
            </Text>
          </TouchableOpacity>
          ...
          {isSOSActive && (
            <View style={styles.activeIndicator}>
              ...
              <Text style={styles.activeIndicatorText}>
                {Platform.OS === "ios"
                  ? "SOUND PLAYING - CHECK DEVICE VOLUME"
                  : "LOUD SOUND PLAYING - EMERGENCY MODE"}
              </Text>
            </View>
          )}
          ...
          <EmergencyButton
            ...
            subtitle={
              isVideoRecording
                ...
                : "Record video with audio for evidence"
            }
        ...
        <View style={styles.section}>
          ...
          <View style={styles.tipsContainer}>
            ...
            <Text style={styles.tip}>
              • Ensure phone is not on silent/vibrate mode
            </Text>
            <Text style={styles.tip}>
              • Grant audio permissions if prompted
            </Text>
            <Text style={styles.tip}>
              • Vibration will work even if sound doesn't play
            </Text>
          </View>
        </View>
      </ScrollView>
